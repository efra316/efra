...
def main():
    ...
    print("===========================================================================================")
    print("{:<10} {:<15} {:<15} {:<15} {:<15} {:<15}".format("NIP", "Nama", "Gaji Pokok", "Lembur", "Uang Makan", "Transport Lembur"))

    print("===========================================================================================")

    total_gaji = hitung_total_gaji(jumlah_jam_kerja)
    
    print("{:<10} {:<15} {:<15} {:<15} {:<15} {:<15}".format(nip, nama, hitung_gaji_pokok(jumlah_jam_kerja), hitung_gaji_lembur(jumlah_jam_kerja), hitung_uang_makan(jumlah_jam_kerja), hitung_uang_transport_lembur(jumlah_jam_kerja)))
